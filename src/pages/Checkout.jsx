...
// Fonction pour convertir les codes hex en noms de couleurs
const getColorName = (hexColor) => {
  const colorMap = {
    ...
    '#1E90FF': 'Dodger bleu',
    '#87CEEB': 'Ciel bleu',
    '#87CEFA': 'Ciel bleu clair',
    '#ADD8E6': 'Bleu clair',
    '#B0C4DE': 'Acier bleu clair',
    '#B0E0E6': 'Turquoise poudré',
    '#5F9EA0': 'Cadet bleu',
    '#008B8B': 'Cyan foncé',
    '#008080': 'Thé',
    ...
    '#8FBC8F': 'Mer foncé',
    '#2E8B57': 'Mer vert',
    '#3CB371': 'Mer printemps',
    '#20B2AA': 'Mer léger',
    '#98FB98': 'Pale vert',
    '#00FF7F': 'Printemps vert',
    '#00FA9A': 'Printemps moyen vert',
...
export default function CheckoutPage() {
  ...
  const handleSubmit = (e) => {
    ...
    items.forEach((item, index) => {
      ...
      if (item.selectedColor) message += `   Couleur: ${getColorName(item.selectedColor)}\n`;
